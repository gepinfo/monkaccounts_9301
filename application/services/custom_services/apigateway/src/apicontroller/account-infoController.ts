...
export class account-infoController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/account-info/:id', this.GpDelete);
this.router.get('/account-info/get/search', this.GpSearch);
this.router.put('/account-info/get/update', this.GpSearchForUpdate);
this.router.put('/account-info', this.GpUpdate);
this.router.get('/account-info/:id', this.GpGetNounById);
this.router.get('/account-info', this.GpGetAllValues);
this.router.post('/account-info', this.GpCreate);
this.router.get('/account-info/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
    }
...
public GpDelete(req: Request, res: Response) {
        ...
        new ApiAdapter().delete(Constant.MONKCHARTOFACCOUNTSURL + `${req.url}` )
...
public GpSearch(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.MONKCHARTOFACCOUNTSURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpSearchForUpdate(req: Request, res: Response) {
        ...
        new ApiAdapter().put(Constant.MONKCHARTOFACCOUNTSURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.MONKCHARTOFACCOUNTSURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
